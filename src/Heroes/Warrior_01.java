...
public class Warrior_01 extends Hero {
    private static final double maxHealth = 300;
    private static final double power = 70;
    private static final double speed = 5;
    private static final String path = "src/Images/Heroes/Warrior_01/Warrior_01__%s_%s.png";
    private static final int numberOfImages = 10;
    private static final int explosionNumber = 1;
    private static final double primaryX = 300;
    private static final double primaryY = 10;
    ...
    public Warrior_01(boolean enemy) throws FileNotFoundException {
