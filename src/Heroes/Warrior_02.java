...
public class Warrior_02 extends Hero {
    private static final double maxHealth = 440;
    private static final double power = 5;
    private static final double speed = 15;
    private static final String path = "src/Images/Heroes/Warrior_02/Warrior_02__%s_%s.png";
    private static final int numberOfImages = 10;
    private static final int explosionNumber = 1;
    private static double primaryX = 360;
    private static double primaryY = 5;
    ...
    public Warrior_02(boolean enemy) throws FileNotFoundException {
