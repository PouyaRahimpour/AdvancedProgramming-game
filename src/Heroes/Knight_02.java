...
public class Knight_02 extends Hero {
    private static final double maxHealth = 300;
    private static final double power = 30;
    private static final double speed = 20;
    private static final String path = "src/Images/Heroes/Knight_02/Knight_02__%s_%s.png";
    private static final int numberOfImages = 10;
    private static final int explosionNumber = 3;
    private static double primaryX = 100+dis;
    ...
    public Knight_02(boolean enemy) throws FileNotFoundException {
