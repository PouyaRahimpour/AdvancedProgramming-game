...
public class Fairy_03 extends Hero {
    private static final double maxHealth = 160;
    private static final double power = 20;
    private static final double speed = 40;
    private static final String path = "src/Images/Heroes/Fairy_03/Fairy_03__%s_%s.png";
    private static final int numberOfImages = 10;
    private static final int explosionNumber = 1;
    private static double primaryX = 100+8*dis;
    ...
    public Fairy_03(boolean enemy) throws FileNotFoundException {
