...
public class Fairy_01 extends Hero {
    private static final double maxHealth = 300;
    private static final double power = 55;
    private static final double speed = 5;
    private static final String path = "src/Images/Heroes/Fairy_01/Fairy_01__%s_%s.png";
    private static final int numberOfImages = 10;
    private static final int explosionNumber = 1;
    private static final double primaryX = 100+6*dis;
    ...
    public Fairy_01(boolean enemy) throws FileNotFoundException {
